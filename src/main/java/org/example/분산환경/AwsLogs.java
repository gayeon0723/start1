    ...
    public static void main(String[] args) {
        try{
            ...
            if (userResult.next()) {
                ...
                System.out.println("Signup Date: " + userResult.getTimestamp("signup_date"));
            }
