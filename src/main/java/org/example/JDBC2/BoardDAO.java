...
public class BoardDAO {
    ...
    public void update(int no값, String content값)
            throws Exception {
        //3. sql준비 --> sql객체
    ...
    public void insert(int no값, String title값, String content값, String writer값)
            throws Exception {
        //3. sql준비 --> sql객체
